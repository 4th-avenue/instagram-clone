    ...
    <ul class="space-y-4 mt-2">
        ...
        <li>
            <a wire:navigate href="/" class="flex items-center gap-5 ">
                ...
                <h4 x-cloak x-show="!(shrink||drawer)"  class="{{ request()->routeIs('/') ? 'font-bold' : 'font-medium' }} text-lg">Home</h4>
            </a>
        </li>
        ...
        <li>
            <a wire:navigate href="{{ route('explore') }}" class="flex items-center gap-5">
                ...
                <h4 x-cloak x-show="!(shrink||drawer)"  class="{{ request()->routeIs('explore') ? 'font-bold' : 'font-medium' }} text-lg">Explore</h4>
            </a>
        </li>
            ...
            <a wire:navigate href="{{ route('reels') }}" class="flex items-center gap-5">
                <span>
                    @if (request()->routeIs('reels'))
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" id="instagram-reel">
                ...
                <h4 x-cloak x-show="!(shrink||drawer)"  class="{{ request()->routeIs('reels') ? 'font-bold' : 'font-medium' }} text-lg">Reel</h4>
            </a>
        </li>
        ...
        <li>
            <a wire:navigate href="{{ route('profile.home', auth()->user()->username) }}" class="flex items-center gap-5">
                ...
                <h4 x-cloak x-show="!(shrink||drawer)"  class="{{ request()->routeIs('profile.home') ? 'font-bold' : 'font-medium' }} text-lg">Profile</h4>
            </a>
        </li>
        @endauth
    </ul>
