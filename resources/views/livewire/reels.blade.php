<div class="lg:px-8 flex flex-col h-full my-auto overflow-hidden">
    <ul class="h-[calc(100vh_-_1rem)] my-auto flex flex-col gap-y-7 snap-y snap-mandatory overflow-x-hidden">
        ...
        <li class="h-[calc(100vh_-_5rem)] m-auto max-w-sm mx-auto w-full cursor-pointer rounded-lg relative group shrink-0 snap-center snap-always grid grid-cols-12 gap-4">
            {{-- main --}}
                ...
                <div class="flex flex-col gap-y-1 items-center">
                    @if ($post->isLikedBy(auth()->user()))
                        <button wire:click="togglePostLike({{ $post->id }})">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-8 text-rose-500">
